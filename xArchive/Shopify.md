...
- GB-Core-2 / Landing Page
- STAR √
- Technical Tradeoffs (GraphQL vs REST API, Redis vs Non Redis, NoSQL vs SQL) -> Outcome √
- Successes
  - Business vs Personal Growth (Mindset) √
- Challenges
  - Lessons Learned √
  - Technical vs Non Technical (Approach / Methodology) √
